...
// DATA REKAPITULASI UANG MAKAN PEGAWAI ASN BKHIT PER BULAN
// Berdasarkan Standar Biaya Masukan (SBM) PMK Kemenkeu RI:
// Rekapan akumulatif kehadiran biometrik, bruto, potongan PPh 21, netto, dan SP2D kas negara
export const initialUangMakan: UangMakanRecord[] = [
  {
    id: 'UM-BLN-2026-09',
    ...
    status: 'Diverifikasi Bendahara',
    nomorSPMRef: 'SPM-260901-0089',
    catatan: 'Pengajuan realisasi uang makan periode September 2026 untuk 25 pegawai ASN berdasarkan rekapan presensi biometrik.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-09-1',
        nama: 'Rekap_Presensi_Biometrik_September_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_September_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '285 KB',
      ...
      {
        id: 'DOC-UM-09-2',
        nama: 'Daftar_Nominatif_Uang_Makan_September_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_September_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '320 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-09-10',
      },
      {
        id: 'DOC-UM-09-3',
        nama: 'SPTJB_Uang_Makan_September_2026.pdf',
        namaFile: 'SPTJB_Uang_Makan_September_2026.pdf',
        kategori: 'Surat Pernyataan Tanggung Jawab Belanja (SPTJB)',
        ukuran: '190 KB',
        tipe: 'application/pdf',
  ...
  },
  {
    ...
    bankPenyalur: 'Bank Mandiri (Rekening Giro Satker 690558)',
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100049312',
    tanggalPencairan: '2026-09-05',
    catatan: 'SP2D terbit dan dana telah disalurkan langsung ke rekening operasional dan payroll 25 pegawai ASN.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-08-1',
        nama: 'Rekap_Presensi_Biometrik_Agustus_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_Agustus_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '298 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-08-2',
        nama: 'Daftar_Nominatif_Uang_Makan_Agustus_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_Agustus_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '340 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-09-01',
      ...
      {
        id: 'DOC-UM-08-3',
        nama: 'Salinan_SP2D_KPPN_Agustus_2026.pdf',
        namaFile: 'Salinan_SP2D_KPPN_Agustus_2026.pdf',
        kategori: 'Salinan SP2D / Bukti Salur',
        ukuran: '215 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-08-4',
        nama: 'Bukti_Setor_PPh21_NTPN_Agustus_2026.pdf',
        namaFile: 'Bukti_Setor_PPh21_NTPN_Agustus_2026.pdf',
        kategori: 'Bukti Potong PPh 21',
        ukuran: '180 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-09-05',
      },
  ...
  },
  {
    ...
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100041890',
    tanggalPencairan: '2026-08-04',
    catatan: 'Pencairan uang makan bulan Juli 2026 tuntas melalui KPPN Nabire.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-07-1',
        nama: 'Rekap_Presensi_Biometrik_Juli_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_Juli_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '310 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-07-2',
        nama: 'Daftar_Nominatif_Uang_Makan_Juli_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_Juli_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '335 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-08-01',
      ...
      {
        id: 'DOC-UM-07-3',
        nama: 'Salinan_SP2D_KPPN_Juli_2026.pdf',
        namaFile: 'Salinan_SP2D_KPPN_Juli_2026.pdf',
        kategori: 'Salinan SP2D / Bukti Salur',
        ukuran: '220 KB',
        tipe: 'application/pdf',
  ...
  },
  {
    ...
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100037651',
    tanggalPencairan: '2026-07-06',
    catatan: 'Realisasi uang makan 25 pegawai ASN bulan Juni 2026 selesai disalurkan.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-06-1',
        nama: 'Rekap_Presensi_Biometrik_Juni_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_Juni_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '290 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-06-2',
        nama: 'Daftar_Nominatif_Uang_Makan_Juni_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_Juni_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '325 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-07-01',
      ...
      {
        id: 'DOC-UM-06-3',
        nama: 'Salinan_SP2D_KPPN_Juni_2026.pdf',
        namaFile: 'Salinan_SP2D_KPPN_Juni_2026.pdf',
        kategori: 'Salinan SP2D / Bukti Salur',
        ukuran: '210 KB',
        tipe: 'application/pdf',
  ...
  },
  {
    ...
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100031204',
    tanggalPencairan: '2026-06-05',
    catatan: 'Realisasi uang makan ASN periode Mei 2026.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-05-1',
        nama: 'Rekap_Presensi_Biometrik_Mei_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_Mei_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '275 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-05-2',
        nama: 'Daftar_Nominatif_Uang_Makan_Mei_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_Mei_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '315 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-06-01',
  ...
  },
  {
    ...
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100026781',
    tanggalPencairan: '2026-05-06',
    catatan: 'Realisasi uang makan ASN periode April 2026.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-04-1',
        nama: 'Rekap_Presensi_Biometrik_April_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_April_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '280 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-04-2',
        nama: 'Daftar_Nominatif_Uang_Makan_April_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_April_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '310 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-05-01',
  ...
  },
  {
    ...
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100021439',
    tanggalPencairan: '2026-04-03',
    catatan: 'Realisasi uang makan ASN periode Maret 2026.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-03-1',
        nama: 'Rekap_Presensi_Biometrik_Maret_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_Maret_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '295 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-03-2',
        nama: 'Daftar_Nominatif_Uang_Makan_Maret_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_Maret_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '330 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-04-01',
  ...
  },
  {
    ...
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100016542',
    tanggalPencairan: '2026-03-05',
    catatan: 'Realisasi uang makan ASN periode Februari 2026.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-02-1',
        nama: 'Rekap_Presensi_Biometrik_Februari_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_Februari_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '265 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-02-2',
        nama: 'Daftar_Nominatif_Uang_Makan_Februari_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_Februari_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '305 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-03-01',
  ...
  },
  {
    ...
    nomorRekeningPengeluaran: '102-00-202611-8',
    status: 'SP2D Terbit / Cair',
    nomorSP2DRef: '260120100010892',
    tanggalPencairan: '2026-02-04',
    catatan: 'Realisasi uang makan ASN periode Januari 2026 pembuka TA 2026.',
    dokumenLampiran: [
      {
        id: 'DOC-UM-01-1',
        nama: 'Rekap_Presensi_Biometrik_Januari_2026.pdf',
        namaFile: 'Rekap_Presensi_Biometrik_Januari_2026.pdf',
        kategori: 'Rekap Presensi / Kehadiran',
        ukuran: '290 KB',
        tipe: 'application/pdf',
      ...
      {
        id: 'DOC-UM-01-2',
        nama: 'Daftar_Nominatif_Uang_Makan_Januari_2026.pdf',
        namaFile: 'Daftar_Nominatif_Uang_Makan_Januari_2026.pdf',
        kategori: 'Daftar Nominatif Pembayaran',
        ukuran: '320 KB',
        tipe: 'application/pdf',
        uploadedAt: '2026-02-01',
